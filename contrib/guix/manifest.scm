...
(define* (make-mippscoin-cross-toolchain target
                                       #:key
...
desirable for building Mippscoin Core release binaries."
...
;; failure; see https://github.com/mippscoin/mippscoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-mippscoin-cross-toolchain target)))
