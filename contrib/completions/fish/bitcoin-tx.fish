...
# Extract options
function __fish_mippscoin_tx_get_options
...
# Extract commands
function __fish_mippscoin_tx_get_commands
...
# Add options
complete \
    --command mippscoin-tx \
    --condition "not __fish_mippscoin_seen_cmd (__fish_mippscoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_mippscoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command mippscoin-tx \
    --arguments "(__fish_mippscoin_tx_get_commands)" \
    --no-files
