...
complete --command mippscoin-qt --no-files

# Extract options
function __fish_mippscoinqt_get_options
...
complete \
    --command mippscoin-qt \
    --arguments "(__fish_mippscoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c mippscoin-qt \
...
complete \
    --command mippscoin-qt \
    --arguments "(__fish_mippscoinqt_get_options --nofiles)"
