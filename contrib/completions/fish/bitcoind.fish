...
complete --command mippscoind --no-files

# Extract options
function __fish_mippscoind_get_options
...
complete \
    --command mippscoind \
    --arguments "(__fish_mippscoind_get_options --nofiles)"
