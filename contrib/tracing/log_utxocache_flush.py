...
"""Example logging Mippscoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/mippscoind
...
def main(mippscoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[mippscoind_with_usdts])
