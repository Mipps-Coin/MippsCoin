...
class TestMippscoinCli(MippscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `mippscoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and mippscoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and mippscoin-cli getwalletinfo return expected wallet info")
            ...
            # Test mippscoin-cli -generate with -rpcwallet in multiwallet mode.
