...
"""
Test starting mippscoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(MippscoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that mippscoind has bound on "::1" (for RPC) and "::" (for P2P).
