...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MippscoinTestFramework
    pass


class ExampleTest(MippscoinTestFramework):
    # Each functional test is a subclass of the MippscoinTestFramework class.
    ...
    def custom_method(self):
        ...
        MippscoinTestFramework class so other tests can use it."""
