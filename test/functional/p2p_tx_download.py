#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Mippscoin Core developers
...
class TxDownloadTest(MippscoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new mippscoind instances, as setting mocktimes has long-term effects on when
