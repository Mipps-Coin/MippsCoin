...
By default, mippscoind will dump mempool on shutdown and
...
class MempoolPersistTest(MippscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mippscoind from writing mempool.dat to disk. Verify that `savemempool` fails")
