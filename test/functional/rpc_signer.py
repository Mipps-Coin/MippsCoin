...
Verify that a mippscoind node can use an external signer command.
...
class RPCSignerTest(MippscoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart mippscoind with -signer=<cmd>',
