...
class TestShell:
    """Wrapper Class for MippscoinTestFramework.

    The TestShell class extends the MippscoinTestFramework
    ...
    class __TestShell(MippscoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MippscoinTestFramework child class.
            self.num_nodes = 1
