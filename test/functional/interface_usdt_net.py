...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/mippscoin/mippscoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(MippscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our mippscoind node")
