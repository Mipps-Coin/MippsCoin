Mippscoin Core version 0.13.2 is now available from:

  <https://mippscoin.org/bin/mippscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update mippscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow mippscoin-tx to create v2 transactions (btcdrak)
