Mippscoin Core version *0.15.0.1* is now available from:

  <https://mippscoin.org/bin/mippscoin-core-0.15.0.1/>

and

  <https://mippscoincore.org/bin/mippscoin-core-0.15.0.1/>
