Mippscoin Core version 0.10.4 is now available from:

  <https://mippscoin.org/bin/mippscoin-core-0.10.4/>
...
- #6953 `43c2789` Split mippscoin-tx into its own package
- #6953 `dfe0d4d` Include mippscoin-tx binary on Debian/Ubuntu
