...
Mippscoin Core version 0.19.1 is now available from:

  <https://mippscoincore.org/bin/mippscoin-core-0.19.1/>
...
From Mippscoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Mippscoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Mippscoin Core does not yet change appearance when
...
- #17488 fix "mippscoind already running" warnings on macOS (fanquake)
