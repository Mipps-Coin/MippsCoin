Mippscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/mippscoin/files/Mippscoin/mippscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Mippscoin
...
New/changed settings (command-line or mippscoin.conf file)
--------------------------------------------------------
