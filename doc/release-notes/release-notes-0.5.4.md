Mippscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/mippscoin/files/Mippscoin/mippscoin-0.5.4/
...
http://gitorious.org/mippscoin/mippscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Mippscoin-Qt notifications under Growl 1.3.
Increase required age of Mippscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMippscoin properly when installing Mippscoin-Qt over it. (Windows)
