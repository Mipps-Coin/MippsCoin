Mippscoin Core version *0.15.2* is now available from:

  <https://mippscoincore.org/bin/mippscoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in mippscoin-tx (TheBlueMatt)
