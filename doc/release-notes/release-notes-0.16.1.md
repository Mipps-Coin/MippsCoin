Mippscoin Core version 0.16.1 is now available from:

  <https://mippscoincore.org/bin/mippscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting mippscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure mippscoind processes are cleaned up when tests end (sdaftuar)
