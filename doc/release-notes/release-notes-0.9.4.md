Mippscoin Core version 0.9.4 is now available from:

  https://mippscoin.org/bin/0.9.4/
...
this update is incompatible with the Mippscoin system and could lead to consensus
forks.

Mippscoin Core released binaries from https://mippscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~mippscoin/+archive/ubuntu/mippscoin
- A third-party or self-compiled Mippscoin Core

upgrade to Mippscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
