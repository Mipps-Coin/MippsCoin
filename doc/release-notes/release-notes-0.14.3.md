Mippscoin Core version *0.14.3* is now available from:

  <https://mippscoin.org/bin/mippscoin-core-0.14.3/>
...
Mippscoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/mippscoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
