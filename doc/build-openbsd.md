...
This guide describes how to build mippscoind, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/mippscoin/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/mippscoin/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Mippscoin Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/mippscoin/mippscoin/issues/6658)).
