...
Mippscoin Core version *version* is now available from:

  <https://mippscoincore.org/bin/mippscoin-core-*version*/>
...
using the Linux Kernel 3.17+, macOS 11.0+, and Windows 7 and newer. Mippscoin
