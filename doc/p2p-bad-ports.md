When Mippscoin Core automatically opens outgoing P2P connections, it chooses
...
A malicious actor may gossip an address:port where no Mippscoin node is listening,
or one where a service is listening that is not related to the Mippscoin network.
As a result, this service may occasionally get connection attempts from Mippscoin
nodes.

"Bad" ports are ones used by services which are usually not open to the public
and usually require authentication. A connection attempt (by Mippscoin Core,
trying to connect because it thinks there is a Mippscoin node on that
...
Below is a list of "bad" ports which Mippscoin Core avoids when choosing a peer to
...
[pull/23306](https://github.com/mippscoin/mippscoin/pull/23306#issuecomment-947516736)

[pull/23542](https://github.com/mippscoin/mippscoin/pull/23542)
