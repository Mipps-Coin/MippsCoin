...
//! Entry point for MippscoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MippscoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MippscoinGUI tests.
void AppTests::guiTests(MippscoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MippscoinGUI::consoleShown, this, &AppTests::consoleTests);
