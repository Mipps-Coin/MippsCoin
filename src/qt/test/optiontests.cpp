...
{
    // Test regression https://github.com/mippscoin/mippscoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/mippscoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/mippscoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Mippscoin/Mippscoin-Qt.conf and all else left as default,
    // mippscoin-qt should set both -listen and -listenonion to false and start successfully.
