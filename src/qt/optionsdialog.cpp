      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->mippscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->mippscoinAtStartup);
    ...
    ui->mippscoinAtStartup->setToolTip(ui->mippscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->mippscoinAtStartup->setText(ui->mippscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openMippscoinConfButton->setToolTip(ui->openMippscoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MippscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->mippscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMippscoinConfButton_clicked()
{
