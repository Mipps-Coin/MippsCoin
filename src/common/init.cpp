// Copyright (c) 2023 The Mippscoin Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // mippscoin.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/mippscoin/mippscoin/issues/16220 about ways to
        ...
        // Show an error or warning if there is a mippscoin.conf file in the
