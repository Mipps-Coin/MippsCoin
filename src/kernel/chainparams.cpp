...
// Copyright (c) 2009-2021 The Mippscoin Core developers
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.mippscoin.dashjr.org."); // Luke Dashjr
        vSeeds.emplace_back("seed.mippscoinstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.mippscoin.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.mippscoin.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.mippscoin.wiz.biz."); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("seed.testnet.mippscoin.sprovoost.nl.");
