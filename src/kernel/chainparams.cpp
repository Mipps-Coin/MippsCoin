...
{
    const char* pszTimestamp = "Sky News 14/Jan/2024 Six arrested over suspected plot to disrupt London Stock Exchange";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 2.5 * 24 * 60 * 60;
        ...
        consensus.defaultAssumeValid = uint256S("0x00"); // 804000
        ...
        genesis = CreateGenesisBlock(1705310628, -2018156643, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000005bcc7fbc07d33eb3db64a2cad882ed93e4fb2e1eb3201a7f093f5d63"));
        assert(genesis.hashMerkleRoot == uint256S("0xec29d034f04a9cbb78af957f094f86cace1945cded1f71f8e09cf0e9ae21dc50"));
        ...
        // vSeeds.emplace_back("seed.mippscoin.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x90, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x90, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00");
        consensus.defaultAssumeValid = uint256S("0x00"); // 2500000
        ...
        genesis = CreateGenesisBlock(1705932264, -2018156643, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000005bcc7fbc07d33eb3db64a2cad882ed93e4fb2e1eb3201a7f093f5d63"));
        assert(genesis.hashMerkleRoot == uint256S("0xec29d034f04a9cbb78af957f094f86cace1945cded1f71f8e09cf0e9ae21dc50"));
        ...
        // vSeeds.emplace_back("testnet-seed.mippscoin.jonasschnelli.ch.");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x90, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x90, 0x83, 0x94};
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.mippscoin.sprovoost.nl.");
            ...
            consensus.nMinimumChainWork = uint256S("0x00");
            consensus.defaultAssumeValid = uint256S("0x00"); // 150000
        ...
        genesis = CreateGenesisBlock(1706510298, -2018156643, 0x1e0377ae, 1, 50 * COIN);
        assert(consensus.hashGenesisBlock == uint256S("0x000000005bcc7fbc07d33eb3db64a2cad882ed93e4fb2e1eb3201a7f093f5d63"));
        assert(genesis.hashMerkleRoot == uint256S("0xec29d034f04a9cbb78af957f094f86cace1945cded1f71f8e09cf0e9ae21dc50"));
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1707077861, -2018156643, 0x207fffff, 1, 50 * COIN);
        assert(consensus.hashGenesisBlock == uint256S("0x000000005bcc7fbc07d33eb3db64a2cad882ed93e4fb2e1eb3201a7f093f5d63"));
        assert(genesis.hashMerkleRoot == uint256S("0xec29d034f04a9cbb78af957f094f86cace1945cded1f71f8e09cf0e9ae21dc50"));
