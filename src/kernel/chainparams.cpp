...
{
    const char* pszTimestamp = "Bloomberg UK 03/Jan/2024 UK Executives Urge BOE to Cut Rates After Confidence Sinks Lower";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1704289488, 0, 0x1d00ffff, 1, 50 * COIN);
