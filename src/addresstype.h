 ...
 *  A CTxDestination is the internal data type encoded in a mippscoin address
 */
...
/**
 * Generate a Mippscoin scriptPubKey for the given CTxDestination. Returns a P2PKH
