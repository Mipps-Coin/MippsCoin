...
{
    BOOST_CHECK(TestSplitHost("www.mippscoincore.org", "www.mippscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.mippscoincore.org]", "www.mippscoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.mippscoincore.org:80", "www.mippscoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mippscoincore.org]:80", "www.mippscoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.mippscoincore.org:65536", "www.mippscoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.mippscoincore.org:0", "www.mippscoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.mippscoincore.org:", "www.mippscoincore.org:", 0, false));
}
