// Copyright (c) 2014-2020 The Mippscoin Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between mippscoin-cli and mippscoind)
 * of a given instance of the Mippscoin system.
 */
